...
public class TopProductChart extends JPanel implements ExampleChart<CategoryChart>{
    ...
    public CategoryChart getChart(){
        ...
        //Add Line
        IncomeChart.addSeries("Product", product, price).setFillColor(Color.WHITE.brighter());
        ...
        cs1.setLegendBackgroundColor(new Color(69, 104, 159));
        ...
        cs1.setToolTipHighlightColor(Color.WHITE.darker());
